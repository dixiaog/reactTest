import { getCategorytList } from '../services/base'
...
export default {
  ...
  effects: {
    *fetch({ payload }, { call, put, select }) {
      ...
      const page = payload && payload.page ? payload.page : Object.assign(yield select(state => state.category.page))
      const {data} = yield call(getCategorytList, { ...searchParam, ...page })
      yield put({
        type: 'changeState',

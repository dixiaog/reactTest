import { getSingleProductInfo, exportSingleProduct } from '../services/inventory/pickBatch'
...
export default {
  ...
  effects: {
    *fetch({ payload }, { call, put }) {
      ...
      const response = yield call(getSingleProductInfo, payload)
      yield put({
        type: 'changeState',
    ...
    *export({ payload }, { call, put }) {
      yield call(exportSingleProduct, payload)
    },

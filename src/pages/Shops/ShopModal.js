...
import { Modal, Form, Input, Switch, Select, Radio } from 'antd'
...
export default class ShopsModal extends Component {
  ...
  componentWillMount () {
    if (this.state.init && this.props.shops && this.props.shops.enable !== undefined) {
      this.setState({
  ...
  render () {
    ...
    const { shopName, shortName, address, shopLevel, sex } = this.props.shops ? this.props.shops : ''
    // , enable

 ...
 * @Last Modified time: 2018-04-19 10:11:14
 * 用户修改密码
 */
...
import { modifyPwd } from '../../../services/system'
    ...
    this.props.form.validateFields({ force: true },
      (err, values) => {
        if (!err) {
          ...
          const params = {}
          Object.assign(params, { userPassword: values.InitPwd, userNewPassword: values.password })
          modifyPwd(params).then((json) => {
            if (json) {
              this.hideModal()
            } else {
              this.setState({

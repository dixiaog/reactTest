...
import { editPower } from '../../../services/system'
...
export default class EditPower extends Component {
  ...
  handleSubmit = () => {
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        Object.assign(values, { permissionNo: this.props.record.permissionNo })
        editPower(values).then((json) => {
          if (json) {
            this.hideModal()
            this.props.dispatch({
              type: 'power/search',
  ...
  render() {
    ...
    const { permissionName, permissionRoute, permissionGroup, permissionTitle, remark } = record
        ...
        >
          ...
          >
            ...
            >
              ...
              <Input size={config.InputSize} placeholder="请输入权限名称" />
            )}
            </FormItem>
            <FormItem
              help={this.state.two}
            ...
            >
              ...
              <Input size={config.InputSize} placeholder="请输入标题" />
            )}
            </FormItem>
            <FormItem

 ...
 * @Last Modified time: 2018-05-12 15:09:47
 * 才审核订单详情
 */
...
export default class OrderDetail extends Component {
  constructor(props) {
    ...
    this.columns = [{
      ...
      key: 'orderNum',
      width: 120,
      render: (text, record) => <div style={{ color: 'blue' }}>×{numeral(text).format('0,0')}</div>,
    }, {
      title: '单价',
      dataIndex: 'salePrice',
      key: 'salePrice',
    ...
    return (
      <div>
        ...
        >
          ...
          >
            <Card type="inner" title="订单基本信息" style={{ width: '937px' }}>
              <Row>
                <Col span={12}>
                  <FormItem
                    {...formItemLayout}
            ...
            <Card type="inner" title="收货地址信息" style={{ width: '937px', marginTop: '20px' }}>
              <FormItem
                {...formItemLayoutT}
                label="收货地址"
              >
                ...
                <div key={i}>
                  <Col span={19} style={{ marginTop: 16 }}>
                    ...
                    <Col span={8}><span style={{ color: '#999' }}>
                      <div style={{ width: 29, float: 'left' }}>单号:</div></span><div style={{ marginLeft: '5px', float: 'left', width: 208 }}>{ele.billNo}</div>
                    </Col>
                  ...
                  <Col span={5}>
                    ...
                    {ele.status === 0 ?
                      ...
                      onClick={this.changePay.bind(this, 3, ele)}
